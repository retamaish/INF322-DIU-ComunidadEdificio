...
import { H1, H2, H3, Navbar } from '@components'
    ...
    <>
      ...
      >
        ...
        >
          <Navbar />
          <hr />
          <H1 className='pay-methods__title'>Paga aquí tu gastos pendientes</H1>
          ...
          <div className='pay-methods__container' style={{ display: 'flex', gap: '2rem', width: '100%' }}>
            ...
            >
              <H2>Monto a cancelar: $123.456</H2>
              <H3 className='pay-methods__subtitle'>Selecciona un método de pago:</H3>
